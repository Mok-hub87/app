...
public class pls_work0 {
    ...
    public static void main(String[] args) {
        try {
            ...
            //addTaskResult1("имя студента","имя задания1",значение true/false(сдано/несдано));
            //addTaskResult2("имя студента","имя задания2",значение);
            //addTaskResult3("имя студента","имя задания3",значение);
